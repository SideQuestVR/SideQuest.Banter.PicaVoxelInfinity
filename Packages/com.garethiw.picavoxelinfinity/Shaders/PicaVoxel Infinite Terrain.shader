...
Shader "PicaVoxel/PicaVoxel Infinite Terrain"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Albedo = ( tex2D( _TileSheet, ( i.uv_texcoord.w < 0.0 ? i.uv_texcoord.xy : uvs_TexCoord13.xy ) ) * i.vertexColor * _Tint ).rgb;
...
ASEEND*/
//CHKSM=781F76801AB3AA723C56BFCB4FD64FD8B979A9C8