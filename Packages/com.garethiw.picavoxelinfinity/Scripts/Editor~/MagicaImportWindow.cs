...
namespace PicaVoxel
{
    public class MagicaImportWindow : EditorWindow
    {
        ...
        public void OnGUI()
        {
            ...
            EditorGUILayout.Space();
            mode = GUILayout.SelectionGrid(mode, new[] {"Single model or World scene", "Multiple models as animation frames"}, 1, EditorStyles.radioButton);
            ...
            if (GUILayout.Button("Select .vox and Import"))
            {
                ...
                {
                    MagicaVoxelImporter.MagicaVoxelImport(fn, objectName, voxelSize, mode);
                    Close();
